            ...
            <div class="content-area container">
                ...
                <div class="site-content">
                    ...
                    <div class="author-field u-textAlignCenter">
                        <img src="images/avatar/{{ isset($article->avatar) ? $article->avatar : rand(1,11).'.jpg' }}" width="64" height="64" alt="{{ $article->author}}" class="avatar avatar-64 wp-user-avatar wp-user-avatar-64 alignnone photo" />                    
                        <h3>
                            {{ $article->author}} 
                        </h3>
