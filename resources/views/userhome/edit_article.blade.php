                    ...
                    <form class="layui-form layui-form-pane login-box" method="POST" >
                        ...
                        <div class="layui-form-item ">
                            ...
                            <div class="layui-input-block">
                                <input id="title" type="text" class="layui-input" lay-verify="require|title" name="title" value="{{ $article->title or  '' }}"  autocomplete="off" placeholder="请输入文章标题">
                            </div>
                        </div>
                        ...
                        <div class="layui-form-item layui-form-text">
                            ...
                            <div class="layui-input-block ">
                                <textarea id="content" name="content" lay-verify="require|content">{{ $article->content or '' }}</textarea>
                            </div>
                        </div>
