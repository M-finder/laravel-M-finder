                    ...
                    height: a.height
                        ...
                        function () {
                            var o = n.contents(),
                                    ...
                                    c = o.find("head"),
                                    s = e(["<style>", "*{margin: 0; padding: 0;}", "::-webkit-scrollbar{width:6px;height:10px;}::-webkit-scrollbar-button:vertical{display:none}::-webkit-scrollbar-corner,::-webkit-scrollbar-track{background:#e2e2e2}::-webkit-scrollbar-thumb{border-radius:0;background-color:#299982}::-webkit-scrollbar-thumb:vertical:hover{background-color:#299982}::-webkit-scrollbar-thumb:vertical:active{background-color:#299982}", "body{padding: 10px; line-height: 20px; overflow-x: hidden; word-wrap: break-word; font: 14px Helvetica Neue,Helvetica,PingFang SC,Microsoft YaHei,Tahoma,Arial,sans-serif; -webkit-box-sizing: border-box !important; -moz-box-sizing: border-box !important; box-sizing: border-box !important;}", "a{color:#01AAED; text-decoration:none;}a:hover{color:#c00}", "p{margin-bottom: 10px;}", "img{display: inline-block; border: none; vertical-align: middle;}", "pre{margin: 10px 0; padding: 10px; line-height: 20px; border-left: 6px solid #0078AD; background-color: #F2F2F2; color: #333; font-family: Courier New; font-size: 12px;}", "img{max-width:100%}", "</style>"].join("")),
                                    u = o.find("body");
                            c.append(s),
                                ...
                                c = {
                                    ...
                                    code: function (e) {
                                        k.call(o,
                                                function (i) {
                                                    v.call(t, "pre", {
                                                        text: i.code.replace(/[<>&"]/g, function (c) {
                                                            return {'<': '&lt;', '>': '&gt;', '&': '&amp;', '"': '&quot;'}[c];
                                                        }),
                                                        "lay-lang": i.lang
                                                    },
